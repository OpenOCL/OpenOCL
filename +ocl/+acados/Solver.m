classdef Solver < handle
  ...
  methods
    function self = Solver(varargin)
      ...
      ocl.utils.assert(isempty(z_bounds.data), ...
        'Bounds on algebraic states are currently not supported in the acados interface.');
      ...
      [lbz, ubz, Jbz] = ocl.acados.bounds(z_lb, z_ub);
