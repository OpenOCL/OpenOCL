...
if isempty(acados_dir)
    error('Please run the acados_setup.sh script in the main directory of OpenOCL. Close Matlab and run it from the command prompt. Only Linux is supported with the acados interface.'); 
end
